...
- [`ContextualValueNode`](./docs/contextualValueNodes/README.md) (abstract)
    ...
    - [`ResolverValueNode`](./docs/contextualValueNodes/ResolverValueNode.md)
- [`CountNode`](./docs/countNodes/README.md) (abstract)
    ...
    - [`RemainderCountNode`](./docs/countNodes/RemainderCountNode.md)
- [`DiscriminatorNode`](./docs/discriminatorNodes/README.md) (abstract)
    ...
    - [`SizeDiscriminatorNode`](./docs/discriminatorNodes/SizeDiscriminatorNode.md)
...
- [`TypeNode`](./docs/typeNodes/README.md) (abstract)
    ...
    - [`ZeroableOptionTypeNode`](./docs/typeNodes/ZeroableOptionTypeNode.md)
