import type { PluginNode, PreOffsetStrategy, PreOffsetTransformNode } from '@codama/node-types';
 ...
 */
export function preOffsetTransformNode<const TPlugins extends Array<PluginNode> | undefined = undefined>(
    offset: number,
    options: {
        strategy?: PreOffsetStrategy;
        plugins?: TPlugins;
    } = {},
): PreOffsetTransformNode<TPlugins> {
