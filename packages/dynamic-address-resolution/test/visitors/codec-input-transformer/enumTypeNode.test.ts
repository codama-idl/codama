...
describe('enumTypeNode', () => {
    ...
    test('should pass through empty variant enum', () => {
        ...
        const transformer = createCodecInputTransformer(dataEnum, rootNodeMock);
    ...
    test('should transform bytes in struct variant', () => {
        ...
        const transformer = createCodecInputTransformer(enumWithStructVariant, rootNodeMock, {
    ...
    test('should transform bytes in tuple variant', () => {
        ...
        const transformer = createCodecInputTransformer(enumWithTupleVariant, rootNodeMock, {
            bytesEncoding: 'base16',
        });
    ...
    test('should throw on unknown variant', () => {
        ...
        const transformer = createCodecInputTransformer(enumWithVariants, rootNodeMock);
    ...
    test('should pass through non-object input for enumTypeNode', () => {
        ...
        const transformer = createCodecInputTransformer(enumNode, rootNodeMock);
    ...
    test('should handle nested enum with multiple bytes fields in struct variant', () => {
        ...
        const transformer = createCodecInputTransformer(complexEnum, rootNodeMock, { bytesEncoding: 'base16' });
    ...
    test('should handle enum with array of bytes in struct variant', () => {
        ...
        const transformer = createCodecInputTransformer(enumWithArray, rootNodeMock, { bytesEncoding: 'base16' });
    ...
    test('should throw on tuple variant without fields', () => {
        ...
        const transformer = createCodecInputTransformer(enumWithTuple, rootNodeMock, { bytesEncoding: 'base16' });
    ...
    test('should handle deeply nested enum variants', () => {
        ...
        const transformer = createCodecInputTransformer(outerEnum, root, { bytesEncoding: 'base16' });
