 ...
 */
export const CODEC_INPUT_TRANSFORMER_SUPPORTED_NODE_KINDS = [
    'amountTypeNode',
    'arrayTypeNode',
    'booleanTypeNode',
    'bytesTypeNode',
...
export type TransformableTypeNodeKind = (typeof CODEC_INPUT_TRANSFORMER_SUPPORTED_NODE_KINDS)[number];

export type CodecInputTransformerOptions = {
 ...
 */
export type CodecInputTransformer = (input: unknown) => unknown;
...
export function createCodecInputTransformerVisitor(
    root: RootNode,
    options: CodecInputTransformerOptions = {},
): Visitor<CodecInputTransformer, TransformableTypeNodeKind> {
    const bytesEncoding = options.bytesEncoding ?? 'base16';

    const visitor: Visitor<CodecInputTransformer, TransformableTypeNodeKind> = {
 ...
 */
export function createCodecInputTransformer(
    typeNode: TypeNode,
    root: RootNode,
    options?: CodecInputTransformerOptions,
): CodecInputTransformer {
