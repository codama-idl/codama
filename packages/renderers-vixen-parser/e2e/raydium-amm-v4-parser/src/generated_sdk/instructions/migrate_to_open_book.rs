...
pub struct MigrateToOpenBook {
    ...
    pub amm_token_coin: solana_program::pubkey::Pubkey,

    pub amm_token_pc: solana_program::pubkey::Pubkey,
    ...
    pub new_amm_open_orders: solana_program::pubkey::Pubkey,

    pub new_serum_program: solana_program::pubkey::Pubkey,

    pub new_serum_market: solana_program::pubkey::Pubkey,
...
pub struct MigrateToOpenBookBuilder {
    ...
    amm_token_coin: Option<solana_program::pubkey::Pubkey>,
    amm_token_pc: Option<solana_program::pubkey::Pubkey>,
    ...
    new_amm_open_orders: Option<solana_program::pubkey::Pubkey>,
    new_serum_program: Option<solana_program::pubkey::Pubkey>,
    new_serum_market: Option<solana_program::pubkey::Pubkey>,
...
impl MigrateToOpenBookBuilder {
    ...
    #[inline(always)]
    pub fn amm_token_coin(&mut self, amm_token_coin: solana_program::pubkey::Pubkey) -> &mut Self {
        self.amm_token_coin = Some(amm_token_coin);
        self
    }
    #[inline(always)]
    pub fn amm_token_pc(&mut self, amm_token_pc: solana_program::pubkey::Pubkey) -> &mut Self {
    ...
    pub fn new_amm_open_orders(
        &mut self,
        new_amm_open_orders: solana_program::pubkey::Pubkey,
    ) -> &mut Self {
    ...
    pub fn new_serum_program(
        &mut self,
        new_serum_program: solana_program::pubkey::Pubkey,
    ) -> &mut Self {
    ...
    pub fn new_serum_market(
        &mut self,
        new_serum_market: solana_program::pubkey::Pubkey,
    ) -> &mut Self {
...
pub struct MigrateToOpenBookCpiAccounts<'a, 'b> {
    ...
    pub amm_token_coin: &'b solana_program::account_info::AccountInfo<'a>,

    pub amm_token_pc: &'b solana_program::account_info::AccountInfo<'a>,
    ...
    pub new_amm_open_orders: &'b solana_program::account_info::AccountInfo<'a>,

    pub new_serum_program: &'b solana_program::account_info::AccountInfo<'a>,

    pub new_serum_market: &'b solana_program::account_info::AccountInfo<'a>,
...
impl<'a, 'b> MigrateToOpenBookCpiBuilder<'a, 'b> {
    ...
    pub fn amm_token_coin(
        &mut self,
        amm_token_coin: &'b solana_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn amm_token_pc(
        &mut self,
        amm_token_pc: &'b solana_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn new_amm_open_orders(
        &mut self,
        new_amm_open_orders: &'b solana_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn new_serum_program(
        &mut self,
        new_serum_program: &'b solana_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn new_serum_market(
        &mut self,
        new_serum_market: &'b solana_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
...
struct MigrateToOpenBookCpiBuilderInstruction<'a, 'b> {
    ...
    amm_token_coin: Option<&'b solana_program::account_info::AccountInfo<'a>>,
    amm_token_pc: Option<&'b solana_program::account_info::AccountInfo<'a>>,
    ...
    new_amm_open_orders: Option<&'b solana_program::account_info::AccountInfo<'a>>,
    new_serum_program: Option<&'b solana_program::account_info::AccountInfo<'a>>,
    new_serum_market: Option<&'b solana_program::account_info::AccountInfo<'a>>,
