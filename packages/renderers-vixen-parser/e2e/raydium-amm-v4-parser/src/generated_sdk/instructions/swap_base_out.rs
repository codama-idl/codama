...
impl SwapBaseOut {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&SwapBaseOutInstructionData::new()).unwrap();
...
pub struct SwapBaseOutInstructionData {
    discriminator: [u8; 1],
}

impl SwapBaseOutInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [11],
        }
...
impl Default for SwapBaseOutInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
/// Instruction builder for `SwapBaseOut`.
///
/// ### Accounts:
///
...
/// Instruction builder for `SwapBaseOut` via CPI.
///
/// ### Accounts:
///
///   0. `[]` token_program
...
///   17. `[signer]` user_source_owner
#[derive(Clone, Debug)]
pub struct SwapBaseOutCpiBuilder<'a, 'b> {
    instruction: Box<SwapBaseOutCpiBuilderInstruction<'a, 'b>>,
}
...
impl<'a, 'b> SwapBaseOutCpiBuilder<'a, 'b> {
    ...
    pub fn invoke_signed(
        ...
        let instruction = SwapBaseOutCpi {
