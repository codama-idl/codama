...
pub const INITIALIZE_POSITION_BUNDLE_WITH_METADATA_DISCRIMINATOR: [u8; 8] =
...
impl InitializePositionBundleWithMetadata {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data =
            borsh::to_vec(&InitializePositionBundleWithMetadataInstructionData::new()).unwrap();
...
impl InitializePositionBundleWithMetadataBuilder {
    ...
    pub fn position_bundle_mint(
        &mut self,
        position_bundle_mint: solana_pubkey::Pubkey,
    ) -> &mut Self {
    ...
    pub fn position_bundle_metadata(
        &mut self,
        position_bundle_metadata: solana_pubkey::Pubkey,
    ) -> &mut Self {
    ...
    pub fn position_bundle_owner(
        &mut self,
        position_bundle_owner: solana_pubkey::Pubkey,
    ) -> &mut Self {
    ...
    pub fn metadata_update_auth(
        &mut self,
        metadata_update_auth: solana_pubkey::Pubkey,
    ) -> &mut Self {
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        let accounts = InitializePositionBundleWithMetadata {
            ...
            position_bundle_metadata: self
                .position_bundle_metadata
                .expect("position_bundle_metadata is not set"),
...
impl<'a, 'b> InitializePositionBundleWithMetadataCpiBuilder<'a, 'b> {
    ...
    pub fn position_bundle_mint(
        &mut self,
        position_bundle_mint: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn position_bundle_metadata(
        &mut self,
        position_bundle_metadata: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn position_bundle_owner(
        &mut self,
        position_bundle_owner: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn metadata_update_auth(
        &mut self,
        metadata_update_auth: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
