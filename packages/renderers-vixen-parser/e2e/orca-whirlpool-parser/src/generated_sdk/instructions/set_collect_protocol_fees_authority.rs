...
pub struct SetCollectProtocolFeesAuthorityBuilder {
    ...
    new_collect_protocol_fees_authority: Option<solana_pubkey::Pubkey>,
...
impl SetCollectProtocolFeesAuthorityBuilder {
    ...
    #[inline(always)]
    pub fn new_collect_protocol_fees_authority(
        &mut self,
        new_collect_protocol_fees_authority: solana_pubkey::Pubkey,
    ) -> &mut Self {
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        let accounts = SetCollectProtocolFeesAuthority {
            ...
            new_collect_protocol_fees_authority: self
                ...
                .expect("new_collect_protocol_fees_authority is not set"),
        };
...
impl<'a, 'b> SetCollectProtocolFeesAuthorityCpiBuilder<'a, 'b> {
    ...
    pub fn new_collect_protocol_fees_authority(
        &mut self,
        new_collect_protocol_fees_authority: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
        self.instruction.new_collect_protocol_fees_authority =
            Some(new_collect_protocol_fees_authority);
        self
    }
    /// Add an additional account to the instruction.
    #[inline(always)]
...
struct SetCollectProtocolFeesAuthorityCpiBuilderInstruction<'a, 'b> {
    ...
    new_collect_protocol_fees_authority: Option<&'b solana_account_info::AccountInfo<'a>>,
