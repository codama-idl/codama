...
impl OpenBundledPositionBuilder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = OpenBundledPosition {
            ...
            position_bundle_authority: self
                .position_bundle_authority
                .expect("position_bundle_authority is not set"),
    ...
    pub fn invoke_signed(
        ...
        let args = OpenBundledPositionInstructionArgs {
            bundle_index: self
                ...
                .bundle_index
                .clone()
                .expect("bundle_index is not set"),
            tick_lower_index: self
                .instruction
                .tick_lower_index
                .clone()
        ...
        let instruction = OpenBundledPositionCpi {
            ...
            bundled_position: self
                .instruction
                .bundled_position
                .expect("bundled_position is not set"),
