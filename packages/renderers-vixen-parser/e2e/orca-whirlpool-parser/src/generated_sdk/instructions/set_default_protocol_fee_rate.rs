...
impl SetDefaultProtocolFeeRate {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&SetDefaultProtocolFeeRateInstructionData::new()).unwrap();
...
impl SetDefaultProtocolFeeRateBuilder {
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        ...
        let args = SetDefaultProtocolFeeRateInstructionArgs {
            default_protocol_fee_rate: self
                .default_protocol_fee_rate
                .clone()
                .expect("default_protocol_fee_rate is not set"),
        };
