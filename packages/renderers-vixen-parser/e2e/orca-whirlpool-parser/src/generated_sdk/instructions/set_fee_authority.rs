...
impl SetFeeAuthority {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = borsh::to_vec(&SetFeeAuthorityInstructionData::new()).unwrap();
...
impl SetFeeAuthorityBuilder {
    ...
    #[inline(always)]
    pub fn new_fee_authority(
        &mut self,
        new_fee_authority: solana_program::pubkey::Pubkey,
    ) -> &mut Self {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = SetFeeAuthority {
            ...
            new_fee_authority: self
                .new_fee_authority
                .expect("new_fee_authority is not set"),
        };
...
impl<'a, 'b> SetFeeAuthorityCpiBuilder<'a, 'b> {
    ...
    pub fn new_fee_authority(
        &mut self,
        new_fee_authority: &'b solana_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
