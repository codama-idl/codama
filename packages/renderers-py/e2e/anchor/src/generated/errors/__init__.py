...
from . import wenTransferGuard


def from_code(code: int) -> typing.Union[wenTransferGuard.CustomError, None]:
    return wenTransferGuard.from_code(code)
...
def from_tx_error(
    error: RPCException,
) -> typing.Union[wenTransferGuard.CustomError, None]:
