...
| [`EnumTypeNode`](https://github.com/codama-idl/spec/blob/main/v1/docs/typeNodes/EnumTypeNode.md)                               | `{ __kind: "Quit", __discriminator: 0 }`                    | Discriminated unions for all enums; the wire honors `variant.discriminator`.                |
