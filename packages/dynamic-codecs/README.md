...
| [`EnumTypeNode`](https://github.com/codama-idl/spec/blob/main/v1/docs/typeNodes/EnumTypeNode.md)                               | `{ __kind: "Quit" }` or `{ __kind: "Move", x: 12, y: 34 }`  | Uses discriminated unions for all enums, including scalar ones.                             |
