...
describe('upgrade', () => {
    ...
    test('it refuses documents with no version', () => {
    ...
    test('it refuses documents from a future major', () => {
    ...
    test('it exposes frozen v1 types that describe v1 documents', () => {
        // Compile-time guarantee: while the latest major is 1, a freshly
        // constructed document satisfies the frozen v1 `RootNode` shape.
