...
pub const UNSTAKE_ALL_REPLICA_MINER_DISCRIMINATOR: [u8; 8] = [250, 4, 3, 209, 154, 125, 71, 168];

/// Accounts.
#[derive(Debug)]
pub struct UnstakeAllReplicaMiner {
    pub mm_owner: solana_pubkey::Pubkey,

    pub replica_mint: solana_pubkey::Pubkey,

    pub replica_mint_token_account: solana_pubkey::Pubkey,
...
impl UnstakeAllReplicaMiner {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = borsh::to_vec(&UnstakeAllReplicaMinerInstructionData::new()).unwrap();
...
pub struct UnstakeAllReplicaMinerInstructionData {
    discriminator: [u8; 8],
}

impl UnstakeAllReplicaMinerInstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for UnstakeAllReplicaMinerInstructionData {
    fn default() -> Self {
        Self::new()
    }
}

/// Instruction builder for `UnstakeAllReplicaMiner`.
///
/// ### Accounts:
///
///   0. `[signer]` mm_owner
///   1. `[writable]` replica_mint
///   2. `[writable]` replica_mint_token_account
///   3. `[writable]` pool
///   4. `[writable]` mm
///   5. `[]` rewarder
///   6. `[writable]` quarry
///   7. `[writable]` miner
///   8. `[writable]` miner_vault
///   9. `[optional]` token_program (default to `TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA`)
///   10. `[optional]` mine_program (default to `QMNeHCGYnLVDn1icRAfQZpjPLBNkfGbSKRB83G5d8KB`)
#[derive(Clone, Debug, Default)]
pub struct UnstakeAllReplicaMinerBuilder {
    mm_owner: Option<solana_pubkey::Pubkey>,
    replica_mint: Option<solana_pubkey::Pubkey>,
    replica_mint_token_account: Option<solana_pubkey::Pubkey>,
...
impl UnstakeAllReplicaMinerBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    #[inline(always)]
    ...
    #[inline(always)]
    pub fn replica_mint_token_account(
        &mut self,
        replica_mint_token_account: solana_pubkey::Pubkey,
    ) -> &mut Self {
        self.replica_mint_token_account = Some(replica_mint_token_account);
        self
    }
    #[inline(always)]
...
/// `unstake_all_replica_miner` CPI accounts.
pub struct UnstakeAllReplicaMinerCpiAccounts<'a, 'b> {
    pub mm_owner: &'b solana_account_info::AccountInfo<'a>,

    pub replica_mint: &'b solana_account_info::AccountInfo<'a>,

    pub replica_mint_token_account: &'b solana_account_info::AccountInfo<'a>,
...
/// `unstake_all_replica_miner` CPI instruction.
pub struct UnstakeAllReplicaMinerCpi<'a, 'b> {
...
impl<'a, 'b> UnstakeAllReplicaMinerCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: UnstakeAllReplicaMinerCpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
            mm_owner: accounts.mm_owner,
            replica_mint: accounts.replica_mint,
            replica_mint_token_account: accounts.replica_mint_token_account,
            pool: accounts.pool,
            mm: accounts.mm,
    ...
    pub fn invoke_signed_with_remaining_accounts(
        ...
        accounts.push(solana_instruction::AccountMeta::new(
            *self.replica_mint_token_account.key,
            false,
        ));
        ...
        account_infos.push(self.replica_mint_token_account.clone());
...
/// Instruction builder for `UnstakeAllReplicaMiner` via CPI.
///
/// ### Accounts:
///
///   0. `[signer]` mm_owner
...
///   10. `[]` mine_program
#[derive(Clone, Debug)]
pub struct UnstakeAllReplicaMinerCpiBuilder<'a, 'b> {
    instruction: Box<UnstakeAllReplicaMinerCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> UnstakeAllReplicaMinerCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(UnstakeAllReplicaMinerCpiBuilderInstruction {
            __program: program,
            mm_owner: None,
            replica_mint: None,
            replica_mint_token_account: None,
            pool: None,
            mm: None,
            rewarder: None,
            quarry: None,
    ...
    pub fn replica_mint_token_account(
        &mut self,
        replica_mint_token_account: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
        self.instruction.replica_mint_token_account = Some(replica_mint_token_account);
        self
    }
    #[inline(always)]
    ...
    #[allow(clippy::vec_init_then_push)]
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        let instruction = UnstakeAllReplicaMinerCpi {
...
#[derive(Clone, Debug)]
struct UnstakeAllReplicaMinerCpiBuilderInstruction<'a, 'b> {
    __program: &'b solana_account_info::AccountInfo<'a>,
    mm_owner: Option<&'b solana_account_info::AccountInfo<'a>>,
    replica_mint: Option<&'b solana_account_info::AccountInfo<'a>>,
    replica_mint_token_account: Option<&'b solana_account_info::AccountInfo<'a>>,
