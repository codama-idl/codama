...
pub const SET_RATE_SETTER_DISCRIMINATOR: [u8; 8] = [59, 193, 107, 111, 94, 23, 64, 107];

/// Accounts.
#[derive(Debug)]
pub struct SetRateSetter {
...
impl SetRateSetter {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = borsh::to_vec(&SetRateSetterInstructionData::new()).unwrap();
...
pub struct SetRateSetterInstructionData {
    discriminator: [u8; 8],
}

impl SetRateSetterInstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for SetRateSetterInstructionData {
    fn default() -> Self {
        Self::new()
    }
}

/// Instruction builder for `SetRateSetter`.
///
/// ### Accounts:
///
///   0. `[writable]` operator
...
pub struct SetRateSetterBuilder {
...
/// `set_rate_setter` CPI accounts.
pub struct SetRateSetterCpiAccounts<'a, 'b> {
...
/// `set_rate_setter` CPI instruction.
pub struct SetRateSetterCpi<'a, 'b> {
...
impl<'a, 'b> SetRateSetterCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: SetRateSetterCpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `SetRateSetter` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` operator
...
///   2. `[]` delegate
#[derive(Clone, Debug)]
pub struct SetRateSetterCpiBuilder<'a, 'b> {
    instruction: Box<SetRateSetterCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> SetRateSetterCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(SetRateSetterCpiBuilderInstruction {
            __program: program,
            operator: None,
            admin: None,
            delegate: None,
    ...
    #[allow(clippy::vec_init_then_push)]
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        let instruction = SetRateSetterCpi {
...
#[derive(Clone, Debug)]
struct SetRateSetterCpiBuilderInstruction<'a, 'b> {
