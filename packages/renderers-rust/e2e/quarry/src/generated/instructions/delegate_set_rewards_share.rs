...
pub const DELEGATE_SET_REWARDS_SHARE_DISCRIMINATOR: [u8; 8] = [111, 198, 20, 112, 172, 82, 102, 66];

/// Accounts.
#[derive(Debug)]
pub struct DelegateSetRewardsShare {
...
impl DelegateSetRewardsShare {
    pub fn instruction(
        &self,
        args: DelegateSetRewardsShareInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&DelegateSetRewardsShareInstructionData::new()).unwrap();
...
pub struct DelegateSetRewardsShareInstructionData {
    discriminator: [u8; 8],
}

impl DelegateSetRewardsShareInstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for DelegateSetRewardsShareInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct DelegateSetRewardsShareInstructionArgs {
    pub new_share: u64,
}

/// Instruction builder for `DelegateSetRewardsShare`.
///
/// ### Accounts:
///
///   0. `[writable]` operator
...
pub struct DelegateSetRewardsShareBuilder {
...
impl DelegateSetRewardsShareBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    #[inline(always)]
    ...
    #[inline(always)]
    pub fn new_share(&mut self, new_share: u64) -> &mut Self {
        self.new_share = Some(new_share);
        self
    }
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        let accounts = DelegateSetRewardsShare {
        ...
        let args = DelegateSetRewardsShareInstructionArgs {
            new_share: self.new_share.clone().expect("new_share is not set"),
        };
...
/// `delegate_set_rewards_share` CPI accounts.
pub struct DelegateSetRewardsShareCpiAccounts<'a, 'b> {
...
/// `delegate_set_rewards_share` CPI instruction.
pub struct DelegateSetRewardsShareCpi<'a, 'b> {
    ...
    pub __args: DelegateSetRewardsShareInstructionArgs,
}

impl<'a, 'b> DelegateSetRewardsShareCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: DelegateSetRewardsShareCpiAccounts<'a, 'b>,
        args: DelegateSetRewardsShareInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `DelegateSetRewardsShare` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` operator
...
///   4. `[writable]` quarry
#[derive(Clone, Debug)]
pub struct DelegateSetRewardsShareCpiBuilder<'a, 'b> {
    instruction: Box<DelegateSetRewardsShareCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> DelegateSetRewardsShareCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(DelegateSetRewardsShareCpiBuilderInstruction {
            __program: program,
            operator: None,
            delegate: None,
            rewarder: None,
    ...
    #[inline(always)]
    pub fn new_share(&mut self, new_share: u64) -> &mut Self {
        self.instruction.new_share = Some(new_share);
        self
    }
    /// Add an additional account to the instruction.
    #[inline(always)]
    ...
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        let args = DelegateSetRewardsShareInstructionArgs {
            new_share: self
                ...
                .new_share
                .clone()
                .expect("new_share is not set"),
        };
        let instruction = DelegateSetRewardsShareCpi {
...
#[derive(Clone, Debug)]
struct DelegateSetRewardsShareCpiBuilderInstruction<'a, 'b> {
