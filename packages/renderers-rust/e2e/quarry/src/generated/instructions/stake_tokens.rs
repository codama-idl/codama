...
pub const STAKE_TOKENS_DISCRIMINATOR: [u8; 8] = [136, 126, 91, 162, 40, 131, 13, 127];
...
impl StakeTokens {
    pub fn instruction(&self, args: StakeTokensInstructionArgs) -> solana_instruction::Instruction {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&StakeTokensInstructionData::new()).unwrap();
