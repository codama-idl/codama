...
pub const SET_QUARRY_CREATOR_DISCRIMINATOR: [u8; 8] = [59, 91, 208, 54, 209, 64, 234, 68];

/// Accounts.
#[derive(Debug)]
pub struct SetQuarryCreator {
...
impl SetQuarryCreator {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = borsh::to_vec(&SetQuarryCreatorInstructionData::new()).unwrap();
...
pub struct SetQuarryCreatorInstructionData {
    discriminator: [u8; 8],
}

impl SetQuarryCreatorInstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for SetQuarryCreatorInstructionData {
    fn default() -> Self {
        Self::new()
    }
}

/// Instruction builder for `SetQuarryCreator`.
///
/// ### Accounts:
///
///   0. `[writable]` operator
...
pub struct SetQuarryCreatorBuilder {
...
/// `set_quarry_creator` CPI accounts.
pub struct SetQuarryCreatorCpiAccounts<'a, 'b> {
...
/// `set_quarry_creator` CPI instruction.
pub struct SetQuarryCreatorCpi<'a, 'b> {
...
impl<'a, 'b> SetQuarryCreatorCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: SetQuarryCreatorCpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `SetQuarryCreator` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` operator
...
///   2. `[]` delegate
#[derive(Clone, Debug)]
pub struct SetQuarryCreatorCpiBuilder<'a, 'b> {
    instruction: Box<SetQuarryCreatorCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> SetQuarryCreatorCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(SetQuarryCreatorCpiBuilderInstruction {
            __program: program,
            operator: None,
            admin: None,
            delegate: None,
    ...
    #[allow(clippy::vec_init_then_push)]
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        let instruction = SetQuarryCreatorCpi {
...
#[derive(Clone, Debug)]
struct SetQuarryCreatorCpiBuilderInstruction<'a, 'b> {
