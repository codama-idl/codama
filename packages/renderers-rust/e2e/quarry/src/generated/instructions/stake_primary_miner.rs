...
pub const STAKE_PRIMARY_MINER_DISCRIMINATOR: [u8; 8] = [72, 59, 23, 242, 117, 178, 129, 138];

/// Accounts.
#[derive(Debug)]
pub struct StakePrimaryMiner {
...
impl StakePrimaryMiner {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = borsh::to_vec(&StakePrimaryMinerInstructionData::new()).unwrap();
...
pub struct StakePrimaryMinerInstructionData {
    discriminator: [u8; 8],
}

impl StakePrimaryMinerInstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for StakePrimaryMinerInstructionData {
    fn default() -> Self {
        Self::new()
    }
}

/// Instruction builder for `StakePrimaryMiner`.
///
/// ### Accounts:
///
///   0. `[signer]` mm_owner
...
pub struct StakePrimaryMinerBuilder {
...
impl StakePrimaryMinerBuilder {
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        let accounts = StakePrimaryMiner {
...
/// `stake_primary_miner` CPI accounts.
pub struct StakePrimaryMinerCpiAccounts<'a, 'b> {
...
/// `stake_primary_miner` CPI instruction.
pub struct StakePrimaryMinerCpi<'a, 'b> {
...
impl<'a, 'b> StakePrimaryMinerCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: StakePrimaryMinerCpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `StakePrimaryMiner` via CPI.
///
/// ### Accounts:
///
///   0. `[signer]` mm_owner
...
///   9. `[]` mine_program
#[derive(Clone, Debug)]
pub struct StakePrimaryMinerCpiBuilder<'a, 'b> {
    instruction: Box<StakePrimaryMinerCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> StakePrimaryMinerCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(StakePrimaryMinerCpiBuilderInstruction {
            __program: program,
            mm_owner: None,
    ...
    #[allow(clippy::vec_init_then_push)]
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        let instruction = StakePrimaryMinerCpi {
...
#[derive(Clone, Debug)]
struct StakePrimaryMinerCpiBuilderInstruction<'a, 'b> {
