...
pub const STAKE_REPLICA_MINER_DISCRIMINATOR: [u8; 8] = [246, 171, 25, 201, 242, 145, 94, 47];

/// Accounts.
#[derive(Debug)]
pub struct StakeReplicaMiner {
...
impl StakeReplicaMiner {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = borsh::to_vec(&StakeReplicaMinerInstructionData::new()).unwrap();
...
pub struct StakeReplicaMinerInstructionData {
    discriminator: [u8; 8],
}

impl StakeReplicaMinerInstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for StakeReplicaMinerInstructionData {
    fn default() -> Self {
        Self::new()
    }
}

/// Instruction builder for `StakeReplicaMiner`.
///
/// ### Accounts:
///
///   0. `[signer]` mm_owner
...
pub struct StakeReplicaMinerBuilder {
...
impl StakeReplicaMinerBuilder {
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        let accounts = StakeReplicaMiner {
...
/// `stake_replica_miner` CPI accounts.
pub struct StakeReplicaMinerCpiAccounts<'a, 'b> {
...
/// `stake_replica_miner` CPI instruction.
pub struct StakeReplicaMinerCpi<'a, 'b> {
...
impl<'a, 'b> StakeReplicaMinerCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: StakeReplicaMinerCpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `StakeReplicaMiner` via CPI.
///
/// ### Accounts:
///
///   0. `[signer]` mm_owner
...
///   10. `[]` mine_program
#[derive(Clone, Debug)]
pub struct StakeReplicaMinerCpiBuilder<'a, 'b> {
    instruction: Box<StakeReplicaMinerCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> StakeReplicaMinerCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(StakeReplicaMinerCpiBuilderInstruction {
            __program: program,
            mm_owner: None,
            replica_mint: None,
    ...
    #[allow(clippy::vec_init_then_push)]
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        let instruction = StakeReplicaMinerCpi {
...
#[derive(Clone, Debug)]
struct StakeReplicaMinerCpiBuilderInstruction<'a, 'b> {
