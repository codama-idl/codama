...
/// Instruction builder for `Instruction3`.
///
/// ### Accounts:
///
...
/// Instruction builder for `Instruction3` via CPI.
///
/// ### Accounts:
///
#[derive(Clone, Debug)]
pub struct Instruction3CpiBuilder<'a, 'b> {
    instruction: Box<Instruction3CpiBuilderInstruction<'a, 'b>>,
}
...
impl<'a, 'b> Instruction3CpiBuilder<'a, 'b> {
    ...
    pub fn invoke_signed(
        ...
        let instruction = Instruction3Cpi {
