...
describe('parseDataByName', () => {
    test('it parses account data by name', () => {
        const root = rootNode(
            programNode({
                accounts: [
                    accountNode({
        ...
        const result = parseDataByName(root, hex('090500416c6963652a'), 'myAccount', 'accountNode');
        expect(result).toStrictEqual({
            data: { age: 42, discriminator: 9, firstname: 'Alice' },
            path: [root, root.program, root.program.accounts[0]],
        });
    ...
    test('it parses event data by name', () => {
        const root = rootNode(
            programNode({
                events: [
                    eventNode({
        ...
        const result = parseDataByName(root, hex('090500416c6963652a'), 'myEvent', 'eventNode');
        expect(result).toStrictEqual({
            data: { age: 42, discriminator: 9, firstname: 'Alice' },
            path: [root, root.program, root.program.events[0]],
        });
    });
    test('it parses tuple event data by name', () => {
        const root = rootNode(
            programNode({
                events: [
                    eventNode({
        ...
        const result = parseDataByName(root, hex('01022a000000'), 'tupleEvent', 'eventNode');
        expect(result).toStrictEqual({
            data: [42],
            path: [root, root.program, root.program.events[0]],
        });
    ...
    test('it parses instruction data by name', () => {
        const root = rootNode(
            programNode({
                instructions: [
                    instructionNode({
        ...
        const result = parseDataByName(root, hex('090500416c6963652a'), 'myInstruction', 'instructionNode');
        expect(result).toStrictEqual({
            data: { age: 42, discriminator: 9, firstname: 'Alice' },
            path: [root, root.program, root.program.instructions[0]],
        });
    ...
    test('it returns undefined for non-existent names', () => {
        const root = rootNode(
            programNode({
                accounts: [
                    accountNode({
        ...
        const result = parseDataByName(root, hex('09'), 'unknownNode');
