...
import { BaseFragment, createFragmentTemplate, joinPath, Path } from '@codama/renderers-core';
...
export function fragmentFromTemplate(fragmentFile: Path, context?: object, options?: ConfigureOptions): Fragment {
    return createFragment(render(joinPath('fragments', fragmentFile), context, options));
}
...
export function getDocblockFragment(lines: Docs, withLineJump = false): Fragment {
