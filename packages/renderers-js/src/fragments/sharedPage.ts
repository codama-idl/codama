...
import { addFragmentImportAlias, addFragmentImports, Fragment, fragment, getPageFragment, RenderScope } from '../utils';

export function getSharedPageFragment(scope: Pick<RenderScope, 'dependencyMap' | 'useGranularImports'>): Fragment {
