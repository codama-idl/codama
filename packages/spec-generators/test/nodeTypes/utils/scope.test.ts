...
import type { RenderOptions } from '../../../src/nodeTypes/options';
import { buildRenderScope, relativeImportPath } from '../../../src/nodeTypes/utils/scope';
...
describe('relativeImportPath', () => {
    ...
    it('reaches a hand-written sibling above generated/ from a top-level file with one ../', () => {
        // From `generated/AccountNode.ts` to `src/Docs.ts` — one level up.
        expect(relativeImportPath('AccountNode', '../Docs')).toBe('../Docs');
    });

    it('reaches a hand-written sibling above generated/ from a subdirectory file with two ../', () => {
        // From `generated/typeNodes/StructTypeNode.ts` to `src/Docs.ts` — two levels up.
        expect(relativeImportPath('typeNodes/StructTypeNode', '../Docs')).toBe('../../Docs');
    });
