...
// Dynamic-instructions-related errors.
// Reserve error codes in the range [2500000-2500999].
export const CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__INSTRUCTION_NOT_FOUND = 2500000;
export const CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__PDA_NOT_FOUND = 2500001;
export const CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__NODE_REFERENCE_NOT_FOUND = 2500002;
export const CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__ACCOUNT_MISSING = 2500003;
export const CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__INVALID_ACCOUNT_ADDRESS = 2500004;
export const CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__UNEXPECTED_ADDRESS_TYPE = 2500005;
export const CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__CANNOT_CONVERT_TO_ADDRESS = 2500006;
export const CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__ACCOUNT_RESOLVER_MISSING = 2500007;
export const CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__CIRCULAR_ACCOUNT_DEPENDENCY = 2500008;
export const CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__UNSUPPORTED_OPTIONAL_ACCOUNT_STRATEGY = 2500009;
export const CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__FAILED_TO_DERIVE_PDA = 2500010;
export const CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__ARGUMENT_MISSING = 2500011;
export const CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__DEFAULT_VALUE_MISSING = 2500012;
export const CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__INVALID_ARGUMENT_INPUT = 2500013;
export const CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__UNEXPECTED_ARGUMENT_TYPE = 2500014;
export const CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__FAILED_TO_ENCODE_ARGUMENT = 2500015;
export const CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__FAILED_TO_EXECUTE_RESOLVER = 2500016;
export const CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__FAILED_TO_VALIDATE_INPUT = 2500017;
export const CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__UNSUPPORTED_NODE = 2500018;
export const CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__INVARIANT_VIOLATION = 2500019;
...
export type CodamaErrorCode =
    ...
    | typeof CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__ACCOUNT_MISSING
    | typeof CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__ACCOUNT_RESOLVER_MISSING
    | typeof CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__ARGUMENT_MISSING
    | typeof CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__CANNOT_CONVERT_TO_ADDRESS
    | typeof CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__CIRCULAR_ACCOUNT_DEPENDENCY
    | typeof CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__DEFAULT_VALUE_MISSING
    | typeof CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__FAILED_TO_DERIVE_PDA
    | typeof CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__FAILED_TO_ENCODE_ARGUMENT
    | typeof CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__FAILED_TO_EXECUTE_RESOLVER
    | typeof CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__FAILED_TO_VALIDATE_INPUT
    | typeof CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__INSTRUCTION_NOT_FOUND
    | typeof CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__INVALID_ACCOUNT_ADDRESS
    | typeof CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__INVALID_ARGUMENT_INPUT
    | typeof CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__INVARIANT_VIOLATION
    | typeof CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__NODE_REFERENCE_NOT_FOUND
    | typeof CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__PDA_NOT_FOUND
    | typeof CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__UNEXPECTED_ADDRESS_TYPE
    | typeof CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__UNEXPECTED_ARGUMENT_TYPE
    | typeof CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__UNSUPPORTED_NODE
    | typeof CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__UNSUPPORTED_OPTIONAL_ACCOUNT_STRATEGY
