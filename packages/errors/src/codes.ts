...
/** @deprecated No longer thrown as of Codama v2, which removed nested type node wrappers. */
...
export const CODAMA_ERROR__VISITORS__INSTRUCTION_ENUM_DATA_FIELD_NOT_FOUND = 1200009;
...
export const CODAMA_ERROR__VISITORS__INVALID_PROVIDED_VALUE = 1200013;
export const CODAMA_ERROR__VISITORS__CANNOT_FLATTEN_STRUCT_WITH_PLUGINS = 1200014;
export const CODAMA_ERROR__VISITORS__UNRECOGNIZED_UPDATE_KEYS = 1200015;
export const CODAMA_ERROR__VISITORS__INSTRUCTION_DATA_FIELD_NOT_FOUND = 1200016;
export const CODAMA_ERROR__VISITORS__INSTRUCTION_ACCOUNT_NOT_FOUND = 1200017;
export const CODAMA_ERROR__VISITORS__DEFINED_TYPE_MEMBER_NOT_FOUND = 1200018;
export const CODAMA_ERROR__VISITORS__CANNOT_SET_INSTRUCTION_DISCRIMINATOR = 1200019;
...
export type CodamaErrorCode =
    ...
    | typeof CODAMA_ERROR__UNSUPPORTED_VERSION
    ...
    | typeof CODAMA_ERROR__VISITORS__CANNOT_SET_INSTRUCTION_DISCRIMINATOR
    ...
    | typeof CODAMA_ERROR__VISITORS__INSTRUCTION_ACCOUNT_NOT_FOUND
    | typeof CODAMA_ERROR__VISITORS__INSTRUCTION_DATA_FIELD_NOT_FOUND
    | typeof CODAMA_ERROR__VISITORS__INSTRUCTION_ENUM_DATA_FIELD_NOT_FOUND
    ...
    | typeof CODAMA_ERROR__VISITORS__INVALID_PROVIDED_VALUE
    | typeof CODAMA_ERROR__VISITORS__RENDER_MAP_KEY_NOT_FOUND
    | typeof CODAMA_ERROR__VISITORS__UNRECOGNIZED_UPDATE_KEYS;
