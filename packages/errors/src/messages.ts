...
export const CodamaErrorMessages: Readonly<{
    ...
    [CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__ARGUMENT_MISSING]: 'Missing argument [$argumentName] in [$instructionName].',
    [CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__CANNOT_CONVERT_TO_ADDRESS]: 'Cannot convert value to Address: [$value].',
    [CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__CIRCULAR_ACCOUNT_DEPENDENCY]: 'Circular dependency detected: [$chain].',
    [CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__DEFAULT_VALUE_MISSING]:
        'Default value is missing for argument [$argumentName] in [$instructionName].',
    [CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__FAILED_TO_DERIVE_PDA]: 'Failed to derive PDA for account [$accountName].',
    [CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__FAILED_TO_ENCODE_ARGUMENT]:
    ...
    [CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__PDA_NOT_FOUND]: 'PDA [$pdaName] not found in IDL. Available: [$available].',
    ...
    [CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__UNSUPPORTED_NODE]: 'Unsupported node kind [$nodeKind].',
    [CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__UNSUPPORTED_OPTIONAL_ACCOUNT_STRATEGY]:
