...
| `renderers-web3js` ([docs](https://github.com/ChiefWoods/renderers-web3js))                     | Generates a JavaScript client compatible with [the legacy web3.js package](https://github.com/solana-foundation/solana-web3.js). | [ChiefWoods](https://github.com/ChiefWoods)   |
